...
local Script = {
    Name = "ASGARD" --\\ This is used for notification.
}
local Misc = {
...
Tracer.Color = Color3.fromRGB(0, 132, 255)
Tracer.Thickness = 1
Tracer.Transparency = 1
_G.TracerVisible = false
_G.TracerColor = Color3.fromRGB(0, 132, 255)
...
watermark_module.name = "ASGARD BETA"
watermark_module.accent = Color3.fromRGB(0, 132, 255)
watermark_module.visible = false

local client_info = loadstring(game:HttpGet("https://raw.githubusercontent.com/strixuy/satinf.vip/main/client_info.lua"))()
local script_info = loadstring(game:HttpGet("https://raw.githubusercontent.com/strixuy/satinf.vip/main/script_info.lua"))()
...
-- \\ Library Launch
local library = loadstring(game:HttpGet("https://pastebin.com/raw/W2aTKMnR"))()
local actualLib = library:initLibrary()
local lib = actualLib:Load({name = "ASGARD ALPHA", sizeX = 425, sizeY = 510, color = Color3.fromRGB(0, 132, 255)})
-- \\ T510
...
-- \\ Configs
local ChosenConfig = Settings:Label("Selected Config: ")
...
Info:Label("Script: ASGARD")
Info:Label("Build: 0.0.4")
Info:Button {
